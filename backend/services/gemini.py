...
async def analizar_planta(nombre_planta: str, lugar_planta: str, bytes_foto: bytes, mime_type: str):
  ...
  Analiza visualmente la planta en la foto para detectar su salud actual teniendo en cuenta que está en el/la {lugar_planta}.
